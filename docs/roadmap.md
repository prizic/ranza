...
4. **Amending a booking and moving a Guest.** Cancelling and no-shows are
...
| Housekeeping room-status lifecycle                                | —           | `accommodation_units.status` allows three states; blueprint 18.2 names six. Check-out is the natural trigger for "dirty" and deliberately does not fire it — `stay.checked_out` is published already, so this workflow is also what gives `apps/worker` its first handler (`apps/worker/src/outbox/subscriptions.ts` names the four candidates and why none could go first)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
