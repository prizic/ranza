...
| Storefront, Operator Workspace, Portal shell, Control Plane      | **partial** | Workspace and Portal are real. `apps/storefront` and `apps/control-plane` are empty directories                                                                                                                |
...
| Runtime roles, RLS verification, pooled and direct connections   | **done**    | `ranza_app` / `ranza_auth`, [ADR 0001](adr/0001-prisma-owns-schema-sql-owns-rls.md), the pgTAP suites                                                                                                          |
| Generic notification, audit, file, task, integration foundations | **partial** | Audit only, deliberately                                                                                                                                                                                       |
