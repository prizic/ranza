...
export const messages: Record<SupportedLocale, Messages> = {
  tr: {
    ...
    dashboard: {
      ...
      roomsOutOfOrder: "Hizmet dışı odalar",
      arrivals: "Gelişler",
      checkedIn: "Giriş yapıldı",
      departures: "Çıkışlar",
  ...
  en: {
    ...
    dashboard: {
      ...
      roomsOutOfOrder: "Rooms out of order",
      arrivals: "Arrivals",
      checkedIn: "Checked in",
      departures: "Departures",
  ...
  ar: {
    ...
    dashboard: {
      ...
      dueBack: "تأخّرت عودتها",
      dueBackDetail: "كان يُفترض أن تعود في {date}.",
      requestReference: "MT-{number}",
      ...
      roomsOutOfOrder: "غرف خارج الخدمة",
      arrivals: "الوصول",
