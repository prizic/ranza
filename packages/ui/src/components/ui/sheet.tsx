...
function SheetContent({
  ...
  /**
   * `end` is the inline end: the right in Turkish and English, the left in
   * Arabic. The physical sides stay for the places that mean a physical one.
   */
  side?: "top" | "right" | "bottom" | "left" | "end";
