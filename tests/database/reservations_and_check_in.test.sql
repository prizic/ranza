...
insert into public.reservations
  ...
  ('3e111111-1111-4111-8111-111111111111',
   ...
   '3c111111-1111-4111-8111-111111111111',
   '3d111111-1111-4111-8111-111111111111',
   '3aa11111-1111-4111-8111-111111111111', 'guest', 'confirmed', (app.property_today('3c111111-1111-4111-8111-111111111111') + 60), (app.property_today('3c111111-1111-4111-8111-111111111111') + 63)),
  ('3e222222-2222-4222-8222-222222222222',
   '3b111111-1111-4111-8111-111111111111',
   '3c222222-2222-4222-8222-222222222222',
   '3d555555-5555-4555-8555-555555555555',
   '3bb11111-1111-4111-8111-111111111111', 'guest', 'confirmed', (app.property_today('3c111111-1111-4111-8111-111111111111') + 60), (app.property_today('3c111111-1111-4111-8111-111111111111') + 63)),
  ('3e333333-3333-4333-8333-333333333333',
   '3a111111-1111-4111-8111-111111111111',
   '3c111111-1111-4111-8111-111111111111',
   '3d333333-3333-4333-8333-333333333333',
   '3aa22222-2222-4222-8222-222222222222', 'resident', 'confirmed',
   (app.property_today('3c111111-1111-4111-8111-111111111111') + 60), (app.property_today('3c111111-1111-4111-8111-111111111111') + 64));
...
insert into public.stays
  ...
  ('3f111111-1111-4111-8111-111111111111',
   ...
   'resident', 'in_house', (app.property_today('3c111111-1111-4111-8111-111111111111') - 24), null);
...
select throws_ok(
  $$insert into public.reservations
    ...
    values ('3a111111-1111-4111-8111-111111111111',
            '3c111111-1111-4111-8111-111111111111',
            '3d111111-1111-4111-8111-111111111111',
            '3aa11111-1111-4111-8111-111111111111', 'guest', (app.property_today('3c111111-1111-4111-8111-111111111111') + 90), (app.property_today('3c111111-1111-4111-8111-111111111111') + 92))$$,
  '42501', NULL,
...
select lives_ok(
  $$insert into public.reservations
    ...
    values ('3a111111-1111-4111-8111-111111111111',
            '3c111111-1111-4111-8111-111111111111',
            '3d111111-1111-4111-8111-111111111111',
            '3aa44444-4444-4444-8444-444444444444', 'guest', (app.property_today('3c111111-1111-4111-8111-111111111111') + 90), (app.property_today('3c111111-1111-4111-8111-111111111111') + 92))$$,
...
select throws_ok(
  $$insert into public.reservations
    ...
    values ('3b111111-1111-4111-8111-111111111111',
            '3c222222-2222-4222-8222-222222222222',
            '3d555555-5555-4555-8555-555555555555',
            '3bb11111-1111-4111-8111-111111111111', 'guest', (app.property_today('3c111111-1111-4111-8111-111111111111') + 90), (app.property_today('3c111111-1111-4111-8111-111111111111') + 92))$$,
  '42501', NULL,
...
select throws_ok(
  $$insert into public.stays
    ...
    values ('3a111111-1111-4111-8111-111111111111',
            ...
            '3d111111-1111-4111-8111-111111111111',
            '33333333-3333-4333-8333-333333333333',
            'resident', 'in_house', (app.property_today('3c111111-1111-4111-8111-111111111111') + 90), (app.property_today('3c111111-1111-4111-8111-111111111111') + 92))$$,
  '42501', NULL,
...
select throws_ok(
  $$insert into public.stays
    ...
    values ('3a111111-1111-4111-8111-111111111111',
            '3c111111-1111-4111-8111-111111111111',
            '3d222222-2222-4222-8222-222222222222',
            'guest', 'reserved', (app.property_today('3c111111-1111-4111-8111-111111111111') + 300), (app.property_today('3c111111-1111-4111-8111-111111111111') + 302))$$,
  '23P01', NULL,
...
select throws_ok(
  $$insert into public.reservations
    ...
    values ('3a111111-1111-4111-8111-111111111111',
            '3c111111-1111-4111-8111-111111111111',
            '3d111111-1111-4111-8111-111111111111',
            '3aa11111-1111-4111-8111-111111111111', 'guest', (app.property_today('3c111111-1111-4111-8111-111111111111') + 120), (app.property_today('3c111111-1111-4111-8111-111111111111') + 122))$$,
  '42501', NULL,
